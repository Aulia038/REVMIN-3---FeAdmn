...
import DetailPaymentRent4 from "./pages/UserPage/Rental/DetailPaymentRent4";
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/hotel/detail-hotel" element={<DetailHotel />} />
      ...
      <Route path="/rental/rent-booking-4" element={<DetailPaymentRent4 />} />
